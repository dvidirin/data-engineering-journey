...
transacao = {'valor': 9000, 'hora': 20}
if transacao['valor'] > 10000 or not 9 <= transacao['hora'] <= 18:
    print("Transação Suspeita!")
else:
    print("Transação Legal!")

### Exercício 6. Contagem de Palavras em Textos
# Objetivo:** Dado um texto, contar quantas vezes cada palavra única aparece nele.

texto = "o rato roeu a roupa do rei de roma e o rei ficou triste"
...
while pagina_atual <= total_paginas:
    print(f"Processando a página {pagina_atual} de {total_paginas}")
    pagina_atual +=1
